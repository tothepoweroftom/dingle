(function(modules) {
  ...
  function(module, exports, __webpack_require__) {
    if (!window.AFRAME) {
      ...
      AFRAME = { components: {}, systems: {} };
      AFRAME.registerComponent = function(name, definition) {
        var NewComponent;
        var proto = {};
        Object.keys(definition).forEach(function(key) {
          proto[key] = { value: definition[key], writable: true };
        });
  ...
  function(module, exports) {
    AFRAME.registerComponent("colors", {
      ...
      ops: {
        ...
        t:
          "color.rgb = vec3(dot(color.rgb, $red), dot(color.rgb, $green), dot(color.rgb, $blue));",
  ...
  function(module, exports) {
    AFRAME.registerComponent("glitch", {
      ...
      init: function() {
        ...
        this.exports = {
          glitch: { fragment: this.fragment, uniforms: this.uniforms }
        };
  ...
  function(module, exports, __webpack_require__) {
    ...
    AFRAME.registerComponent("ssao", {
      ...
      tock: function(time) {
        ...
        ].value = this.el.sceneEl.camera.projectionMatrix;
